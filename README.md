...
[![Build Status](https://travis-ci.org/spectra-fund/go-binance.svg?branch=master)](https://travis-ci.org/spectra-fund/go-binance)
[![GoDoc](https://godoc.org/github.com/spectra-fund/go-binance?status.svg)](https://godoc.org/github.com/spectra-fund/go-binance)
[![Go Report Card](https://goreportcard.com/badge/github.com/spectra-fund/go-binance)](https://goreportcard.com/report/github.com/spectra-fund/go-binance)
[![codecov](https://codecov.io/gh/spectra-fund/go-binance/branch/master/graph/badge.svg)](https://codecov.io/gh/spectra-fund/go-binance)
...
```shell
go get github.com/spectra-fund/go-binance
```
...
```golang
import (
    "github.com/spectra-fund/go-binance"
)
```
...
Following are some simple examples, please refer to [godoc](https://godoc.org/github.com/spectra-fund/go-binance) for full references.
